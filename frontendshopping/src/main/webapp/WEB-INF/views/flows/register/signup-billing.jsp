				...
				<div class="panel-body">
					...
					<sf:form method="POST" modelAttribute="billing"
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineOne">Direccion 1
								</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="addressLineTwo">Direccion 2
								</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="postalCode">Codigo Postal
								</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="state">Departamento</label>
							<div class="col-md-8">
